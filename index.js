...
/** Upcoming Deliveries **/
app.get("/api/project_management/upcoming_deliveries", async (req, res) => {
  try {
    // console.log('Access token:', access_token);
    const appName = "machinemaze-project-management";
...
/** Quality Check **/
app.get("/api/project_management/quality_check", async (req, res) => {
  try {
    // console.log('Access token:', access_token);
    const appName = "machinemaze-project-management";
...
/** Module 3 - Purchase **/
/** View Vendor PO **/
app.get("/api/purchase/vendor_pos", async (req, res) => {
  try {
    // console.log('Access token:', access_token);
...
app.get("/api/purchase/vendor_invoices", async (req, res) => {
  try {
    // console.log('Access token:', access_token);
    const appName = "purchase-application";
...
app.get("/api/purchase/req_view_payments", async (req, res) => {
  try {
    // console.log('Access token:', access_token);
...
/** Module 4 - Drawings **/
/** Add Drawings **/
app.get("/api/drawings/add_drawings", async (req, res) => {
  try {
    // console.log('Access token:', access_token);
    const appName = "purchase-application";
    const reportName = "Approved_POs";
...
/** View Drawings **/
app.get("/api/drawings/view_drawings", async (req, res) => {
  try {
    // console.log('Access token:', access_token);
